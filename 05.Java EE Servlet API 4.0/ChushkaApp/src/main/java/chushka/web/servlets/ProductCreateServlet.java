...
public class ProductCreateServlet extends HttpServlet {
    private final static String CREATE_PRODUCT_HTML_FILE_PATH = "views/create-product.html";
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        String htmlFileContent = this.htmlReader.readHtmlFile(CREATE_PRODUCT_HTML_FILE_PATH).replace(" {{typeOptions}}", this.formatTypeOptions());
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        productServiceModel.setProductType(req.getParameter("type"));
    ...
    private String formatTypeOptions() {
        ...
        Arrays.stream(ProductType.values()).forEach(t -> {
            options.append(String.format("<option value=\"%s\">%s</option>", t.name(), t.name())).append(System.lineSeparator());
        });
